  ...
  return (
    <Html>
      <Head>
        ...
        <link href="/images/favicon/icon-16x16.png" rel="icon" type="image/png" sizes="16x16" />
        <link href="/images/favicon/icon-32x32.png" rel="icon" type="image/png" sizes="32x32" />
        <link rel="apple-touch-icon" href="/images/favicon/icon-192x192.png"></link>
